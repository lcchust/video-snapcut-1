...
void GraphCutTester::calc_NWeights(cv::Mat& leftW, cv::Mat& upleftW,
...
void GraphCutTester::construct_graph(const cv::Mat& leftW,
                                     const cv::Mat& upleftW, const cv::Mat& upW,
                                     const cv::Mat& uprightW) {
